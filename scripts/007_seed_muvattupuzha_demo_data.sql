...
('St. Mary\'s Hospital', 'Market Junction, Muvattupuzha, Ernakulam, Kerala', '+91-484-2345678', 'info@stmaryshospital.com', ARRAY['Gynecology', 'Orthopedics', 'Neurology'], true, 9.9785, 76.5775, 4.3),
...
('Muvattupuzha Women\'s Hospital', 'Church Road, Muvattupuzha, Ernakulam, Kerala', '+91-484-6789012', 'contact@muvattupuzhawomens.com', ARRAY['Gynecology', 'Pediatrics'], false, 9.9740, 76.5740, 4.0),
...
((SELECT id FROM public.hospitals WHERE name = 'St. Mary\'s Hospital'), 'Dr. Rajesh Menon', 'Neurology', 'DM', 15, '+91-9847034567', 'rajesh.menon@stmaryshospital.com', 1800.00, ARRAY['Monday', 'Tuesday', 'Thursday'], '9:00 AM - 3:00 PM', 4.6),
...
((SELECT id FROM public.hospitals WHERE name = 'Muvattupuzha Women\'s Hospital'), 'Dr. Latha Joseph', 'Gynecology', 'MD', 14, '+91-9847078901', 'latha.joseph@muvattupuzhawomens.com', 1400.00, ARRAY['Monday', 'Wednesday'], '10:00 AM - 3:00 PM', 4.3),
